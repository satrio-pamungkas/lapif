$(document).ready(function () {
    ...
    $(document).ready(function (e) {
        var result = Paging(1, 5, 50, "diskusi", "disable-diskusi");
        $("#pagination-diskusi").html(result)
    });

    $("#pagination-diskusi").on("click", "a", function () {
        var result = Paging($(this).attr("pn"), 5, 50, "diskusi", "disable-diskusi");
        $("#pagination-diskusi").html(result)
    });
