$(document).ready(function () {
    ...
    $(document).ready(function (e) {
        var result = Paging(1, 5, 50, "laporan", "disable-laporan");
        $("#pagination-laporan").html(result)
    });

    $("#pagination-laporan").on("click", "a", function () {
        var result = Paging($(this).attr("pn"), 5, 50, "laporan", "disable-laporan");
        $("#pagination-laporan").html(result)
    });
