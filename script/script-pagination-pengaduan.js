$(document).ready(function () {
    ...
    $(document).ready(function (e) {
        var result = Paging(1, 5, 50, "pengaduan", "disable-pengaduan");
        $("#pagination-pengaduan").html(result)
    });

    $("#pagination-pengaduan").on("click", "a", function () {
        var result = Paging($(this).attr("pn"), 5, 50, "pengaduan", "disable-pengaduan");
        $("#pagination-pengaduan").html(result)
    });
